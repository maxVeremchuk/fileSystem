...
public class SuperBlock {
  ...
  /** Offset in blocks of the free list block region from the beginning of the file system. */
  private int freeListBlockOffset;

  /** Offset in blocks of the inode block region from the beginning of the file system. */
  private int inodeBlockOffset;

  /** Offset in blocks of the data block region from the beginning of the file system. */
  ...
  public void write(RandomAccessFile file) throws IOException {
    ...
    for (int i = 0; i < blockSize - 18; i++) file.write((byte) 0);
  }
